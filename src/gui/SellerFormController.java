...
public class SellerFormController implements Initializable {
	...
	public void loadAssociatedObjects() {
		if (departmentService == null) {
			throw new IllegalStateException("DepartmentService está vazio!");
		}
	...
	private void setErrorsMessages(Map<String, String> errors) {
		...
		labelErrorName.setText(fields.contains("name") ? errors.get("name") : "" );//if 

		labelErrorEmail.setText(fields.contains("email") ? errors.get("email") : "" );//if
		
		labelErrorBirthDate.setText(fields.contains("birthDate") ? errors.get("birthDate") : "" );//if
		
		labelErrorBaseSalary.setText(fields.contains("baseSalary") ? errors.get("baseSalary") : "" );//if
	}
